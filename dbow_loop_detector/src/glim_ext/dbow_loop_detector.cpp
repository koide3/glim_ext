...
public:
  ...
  bool validate_loop(const gtsam_ext::Frame::ConstPtr& frame1, const gtsam_ext::Frame::ConstPtr& frame2, Eigen::Isometry3d& T_frame1_frame2, double& inlier_fraction) const {
    gtsam::Values values;
